import { Shield, Eye, Zap, AlertTriangle, Clock, TrendingUp } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Continuous surveillance of your network and systems with real-time threat detection.',
      capabilities: ['Network Traffic Analysis', 'Endpoint Monitoring', 'Log Aggregation', 'Behavioral Analytics']
    },
    {
      icon: Zap,
      title: 'AI-Powered Detection',
      description: 'Advanced machine learning algorithms to identify known and unknown threats.',
      capabilities: ['Anomaly Detection', 'Pattern Recognition', 'Predictive Analytics', 'False Positive Reduction']
    },
    {
      icon: AlertTriangle,
      title: 'Rapid Response',
      description: 'Immediate threat containment and neutralization to minimize impact.',
      capabilities: ['Automated Response', 'Threat Isolation', 'Evidence Preservation', 'Communication Protocols']
    },
    {
      icon: TrendingUp,
      title: 'Threat Intelligence',
      description: 'Global threat intelligence feeds to stay ahead of emerging attack vectors.',
      capabilities: ['IOC Integration', 'Threat Hunting', 'Risk Scoring', 'Attribution Analysis']
    }
  ];

  const threatTypes = [
    { name: 'Malware & Ransomware', detected: '99.8%', description: 'Advanced malware detection including zero-day threats' },
    { name: 'Phishing Attacks', detected: '99.5%', description: 'Email-based social engineering attack prevention' },
    { name: 'Insider Threats', detected: '95.2%', description: 'Behavioral analysis to detect internal security risks' },
    { name: 'APT Groups', detected: '92.7%', description: 'Advanced persistent threat detection and tracking' },
    { name: 'Data Exfiltration', detected: '98.1%', description: 'Unauthorized data transfer detection and prevention' },
    { name: 'Network Intrusions', detected: '97.9%', description: 'Lateral movement and privilege escalation detection' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            Advanced AI-powered threat detection with rapid response capabilities to neutralize 
            security incidents before they impact your business operations.
          </p>
        </div>
            ...
            {threatTypes.map((threat, index) => (
              <div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-slate-600">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-2xl font-bold text-green-400">{threat.detected}</span>
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <p className="text-gray-300 mb-8">
              Our automated threat response system ensures rapid identification, analysis, and containment 
              of security threats with minimal human intervention required.
            </p>
                ...
                <div key={index} className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="font-semibold text-green-400">{process.title}</h3>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-green-600 to-cyan-600 rounded-2xl px-8 py-12">
            ...
            <p className="text-green-100 mb-8 max-w-2xl mx-auto">
              Get a free threat assessment and see how our advanced detection capabilities 
              can protect your organization from sophisticated cyber attacks.
            </p>
